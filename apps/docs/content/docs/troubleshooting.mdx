...
|---------|-----------------|
| `@tanstack/react-query` | 5.102.8, within v5 |
| `@elysiajs/eden` | 1.3.0 |
| `elysia` | 1.3.0 |
| `typescript` | 5.5.2 |

React Query versions below 5.102.8 are outside the supported peer range. See [Upgrading from an earlier release](/docs/getting-started#upgrading-from-an-earlier-release) for the dependency migration.
